...
it('can parse a search string without ranges', parseSearch('abc -def -" ghi jkl" mno "pqr "') == [['abc', 'mno', 'pqr'], [], ['def', 'ghi jkl'], []]);
it('can parse a simple phrase', parseSearch('"am Himmel"') == [['am Himmel'], [], [], []]);
it('converts user wildcards (*) to SQL LIKE wildcards (%)', parseSearch('frühling -wien* -"100%"') == [['frühling'], [], ['wien%', '100%%'], []]);
